...
import recipes.repos.CategoryRepo;
import recipes.repos.RecipeRepo;
import recipes.repos.UnitOfMeasureRepo;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepo categoryRepository, RecipeRepo recipeRepository, UnitOfMeasureRepo unitOfMeasureRepository) {
